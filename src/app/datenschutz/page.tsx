    ...
    return (
        <div className="min-h-screen bg-white pt-24">
            <div className="mx-auto max-w-4xl px-6 py-12">
                ...
                <section className="mb-8">
                    <h2 className="mb-4 text-2xl font-semibold">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                    ...
                    <p className="mb-2">
                        Telefon:{' '}
                        <a href="tel:+491724067926" className="text-blue-600 hover:underline">
                            +49 172 4067926
                        </a>
                    </p>
                    <p className="mb-4">
                        E-Mail:{' '}
                        <a href="mailto:walk-with-us@web.de" className="text-blue-600 hover:underline">
                            walk-with-us@web.de
                        </a>
                    </p>
                    <p className="mb-4">
                    ...
                    <h3 className="mb-3 text-xl font-semibold">Auskunft, Löschung und Berichtigung</h3>
                    <p className="mb-4">
                ...
                <section className="mb-8">
                    <h2 className="mb-4 text-2xl font-semibold">4. Datenerfassung auf dieser Website</h2>
                ...
                <section className="mb-8">
                    <h2 className="mb-4 text-2xl font-semibold">5. Soziale Medien</h2>

                    <h3 className="mb-3 text-xl font-semibold">Social-Media-Links</h3>
                    <p className="mb-4">
                        Wir verlinken auf unserer Website zu unseren Präsenzen in sozialen Netzwerken
                        (Facebook, Instagram). Durch das Anklicken dieser Links werden Sie zu den jeweiligen
                        Plattformen weitergeleitet. Für die Verarbeitung Ihrer Daten auf diesen Plattformen
                        sind die jeweiligen Betreiber verantwortlich. Bitte informieren Sie sich dort über
